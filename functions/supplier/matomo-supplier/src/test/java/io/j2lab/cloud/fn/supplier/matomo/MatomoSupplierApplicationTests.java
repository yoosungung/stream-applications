...
@DirtiesContext
public class MatomoSupplierApplicationTests {

	@Autowired
	private Supplier<Flux<Message<byte[]>>> MatomoSupplier;
	...
	@Test
	public void testMatomoPost() throws SSLException {
		...
		Flux<Message<byte[]>> messageFlux = this.MatomoSupplier.get();
		...
		webClient.post()
				.uri("/matomo.php?aaa=1&bbb=2&ccc=3")
				.bodyValue("{\"ddd\":\"4\", \"eee\":\"5\"}")
				.retrieve()
				.toBodilessEntity()
...
//				.block(Duration.ofSeconds(10));
	...
	static class MatomoSupplierTestApplication {
